...
// Keep this as a project-level preference; change if you want a different default.
...
// LoRa app-level encryption/auth is NOT implemented.
// For safety, we include a per-project sync word + simple CRC.
